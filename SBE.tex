...
\title{\Huge\bf Squeak by example -- OLPC edition}
\isodate
...
% Introduction to the OLPC platform
%\input{OLPC/Introduction.tex}
% An EToys tour
%\input{Etoys/EtoysTour.tex}
%--- Orig ----
%:Quick Tour
...
%:PART 4 -- Squeak on the OLPC
\part{Squeak on the OLPC}

% Programming Etoys

% Accessing OLPC platform from Squeak

% Into a complex Application : DrGeo 2
